...
public class OrderRegStatusController {
    ...
    public String addNewOrder(@RequestParam String customername, @RequestParam String address, @RequestParam LocalDateTime dateorder,@RequestParam String productorder, @RequestParam Integer quantityorder, @RequestParam PaymentStatus paymentstatus, @RequestParam DeliveryStatus deliverystatus) {
